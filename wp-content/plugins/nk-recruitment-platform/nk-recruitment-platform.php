...
function nkrp_safe_render_view(string $file_path, array $variables = []): void {
    ...
    try {
        ...
        if (current_user_can('manage_options')) {
            echo '<div style="background:#fff5f5; color:#c53030; padding:20px; border-left:4px solid #e53e3e; margin:20px 0; font-family:monospace; border-radius:6px; box-shadow: 0 2px 4px rgba(0[...]';
