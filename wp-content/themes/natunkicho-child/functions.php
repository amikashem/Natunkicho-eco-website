...
//require_once get_stylesheet_directory() . '/inc/jobs/ecosystem-teaser.php';
//require_once get_stylesheet_directory() . '/inc/jobs/featured-jobs-shortcode.php';
//require_once get_stylesheet_directory() . '/inc/jobs/jobs-functions.php';
//require_once get_stylesheet_directory() . '/inc/jobs/jobs-apply.php';
//require_once get_stylesheet_directory() . '/inc/jobs/jobs-save.php';
//require_once get_stylesheet_directory() . '/inc/jobs/premium-job-submit.php';
//require_once get_stylesheet_directory() . '/inc/jobs/taxonomy-fixes.php';

// --- 6. LOAD DASHBOARD & CORE AUTH ---
//require_once get_stylesheet_directory() . '/inc/dashboard/dashboard-router.php';
//require_once get_stylesheet_directory() . '/inc/dashboard/messages.php';
//require_once get_stylesheet_directory() . '/inc/core/roles.php';
//require_once get_stylesheet_directory() . '/inc/auth/auth-functions.php';
//require_once get_stylesheet_directory() . '/inc/core/notifications.php';
//require_once get_stylesheet_directory() . '/inc/auth/auth-split-screen.php';
//require_once get_stylesheet_directory() . '/inc/auth/login.php';
//require_once get_stylesheet_directory() . '/inc/auth/register.php';
//require_once get_stylesheet_directory() . '/inc/auth/nk-social-oauth.php';

// --- 7. LOAD CANDIDATE & AI SYSTEM ---
//require_once get_stylesheet_directory() . '/inc/ai/ai-cv-builder.php';
//require_once get_stylesheet_directory() . '/inc/ai/ai-skill-suggestions.php';
//require_once get_stylesheet_directory() . '/inc/ai/ai-summary-generator.php';
//require_once get_stylesheet_directory() . '/inc/ai/ai-job-generator.php';
//require_once get_stylesheet_directory() . '/inc/candidate/candidate-profile.php';
//require_once get_stylesheet_directory() . '/inc/candidate/candidate-saved-jobs.php';
//require_once get_stylesheet_directory() . '/inc/candidate/candidate-applied-jobs.php';
//require_once get_stylesheet_directory() . '/inc/candidate/cv-public-view.php';
//require_once get_stylesheet_directory() . '/inc/candidate/candidate-alerts.php';

// --- 8. LOAD EMPLOYER SYSTEM ---
//require_once get_stylesheet_directory() . '/inc/employer/employer-dashboard.php';
//require_once get_stylesheet_directory() . '/inc/employer/employer-jobs.php';
