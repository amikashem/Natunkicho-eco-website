...
= 1.2.10 =
* Enhancement: Reconfigured the plugin's main settings page.
...
* Fixed: PHP warning for missing referred order subtotal in WooCommerce integration.
* Misc: Small formatting improvements.
...
* Fixed: Faulty redirect from admin commissions table to Paid Memberships Pro order edit page.
* Fixed: The way that the reference amount is saved for affiliate commissions for certain integrations.

= 1.2.3 =
* Enhancement: Refactored the affiliate payable commissions calculation system to improve performance.
* Fixed: Fatal error when calculating commissions for dynamically created order items in WooCommerce.
* Misc: Added the "required" HTML attribute to the terms and conditions checkbox.

= 1.2.2 =
* Enhancement: When querying affiliate commissions, you can now use an array of IDs for the "parent_id" parameter.
* Fixed: "Week to date" affiliate account date picker not setting the correct dates.
* Misc: Rebuilt translation files.

= 1.2.1 =
* Fixed: Deprecated creation of dynamic properties issue for affiliate account tables.

= 1.2.0 =
* New: Commission items for affiliate commissions generated by referred orders made in WooCommerce, Easy Digital Downloads and Paid Memberships Pro.
