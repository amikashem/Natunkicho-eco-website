...
$tabs = array(
	...
	'commissions' => array(
		...
		'icon'	=> '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6" /><circle cx="16.5" cy="16.5" r="2.5" stroke-linecap="round" stroke-linejoin="round" /><circle cx="7.5" cy="7.5" r="2.5" stroke-linecap="round" stroke-linejoin="round" /></svg>'
	),
	'affiliate_area' => array(
		'label'	=> __( 'Affiliate Area', 'slicewp' ),
		'icon'	=> '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" /></svg>'
	),
	'integrations' => array(
		'label' => __( 'Integrations', 'slicewp' ),
		'icon'  => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z" /></svg>'
	),
	'emails' => array(
...
<div class="wrap slicewp-wrap slicewp-wrap-settings">
	...
	<form action="" method="POST">
		...
		<div class="slicewp-settings-layout">

			<!-- Sidebar Navigation -->
			<div class="slicewp-settings-sidebar">

				<div class="slicewp-settings-sidebar-header">
					<h1><?php echo esc_html__( 'Settings', 'slicewp' ); ?></h1>
				</div>
			...
			<!-- Tab Content -->
			<div class="slicewp-settings-content">
				...
				<?php foreach ( $tabs as $tab_slug => $tab ): ?>
					...
					<div class="slicewp-tab <?php echo ( $active_tab == $tab_slug ? 'slicewp-active' : '' ); ?>" data-tab="<?php echo esc_attr( $tab_slug ); ?>">
						...
						<h2 class="slicewp-settings-content-title"><?php echo esc_html( $tab['label'] ); ?></h2>

						<?php

							if ( file_exists( plugin_dir_path( __FILE__ ) . 'view-settings-tab-' . str_replace( '_', '-', $tab_slug ) . '.php' ) ) {

								include_once plugin_dir_path( __FILE__ ) . 'view-settings-tab-' . str_replace( '_', '-', $tab_slug ) . '.php';
